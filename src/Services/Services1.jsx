...
import { Navbar, ScrollArea, Text, Image, Center, Button, Transition, rem, Affix, AppShell } from '@mantine/core';
import { Link, useParams } from 'react-router-dom';
import './NavbarStyled1.css';
...
const Services1 = () => {
      ...
      label: 'Reverse Engineering', content:
        <div style={{ justifyContent: 'center', alignContent: 'center' }}>
          <ScrollArea h={700}>
            ...
            <Text fz={20} fw='bold' style={{ fontFamily: '"Marcellus", Sans-serif', animation: isVisible ? "slideInBottomToTop 3s ease-out" : "slideInBottomToTop 3s ease-out" }}>Reverse Engineering: PCB Prototyping, Testing, and Retrofitting</Text>
            <Text fz={17.5} style={{ fontFamily: '"Open Sans", Sans-serif', animation: isVisible ? "slideInBottomToTop 3s ease-out" : "slideInBottomToTop 3s ease-out" }} >At Aaradhya Techno Solutions, we specialize in the reverse engineering of printed circuit boards (PCBs) to help customers overcome challenges such as obsolete components or unavailability of design data. By analyzing a sample board, including its components, we recreate all necessary data, enabling duplication or upgrades. Our expertise extends to reverse engineering PCBs with programmed integrated circuits, custom parts, and obsolete technologies, ensuring compatibility with modern requirements.</Text>


            <Center mt='5rem' >
              <Image src='https://www.venture-mfg.com/wp-content/uploads/2018/12/Figure-18-PCB-Assembly.jpg' width='70vh' style={{ animation: isVisible ? "slideInBottomToTop 3s ease-out" : "slideInBottomToTop 3s ease-out", }}> </Image>
            </Center>
            <div style={{ marginTop: '2rem' }}>
              <Text fz={20} style={{ fontFamily: '"Marcellus", Sans-serif', animation: isVisible ? "slideInBottomToTop 3s ease-out" : "slideInBottomToTop 3s ease-out", }} fw='bold' >Step-by-Step Process of PCB Reverse Engineering </Text>
              <Text fz={17.5} style={{ fontFamily: '"Open Sans", Sans-serif', animation: isVisible ? "slideInBottomToTop 3s ease-out" : "slideInBottomToTop 3s ease-out", }}>
                <ol type='1'>
                  <li>
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: '3.5rem', animation: isVisible ? "slideInBottomToTop 3s ease-out" : "slideInBottomToTop 3.5s ease-out", }}>
                <div style={{ flex: 1 }}>
                  <Text fz={20} fw='bold' style={{ fontFamily: '"Marcellus", Sans-serif', }}>PCB Highlights: Laser Range Finder Board
                  </Text>


                  <Text fz={17.5} style={{ fontFamily: '"Open Sans", Sans-serif', }}>The redesigned PCB for the LRF retained the pentagon shape of the original board while incorporating green solder mask layers. The back side of the PCB was optimized to enhance durability and accommodate modern component layouts.
                  </Text>
                  <Text fz={17.5} mt='xl' style={{ fontFamily: '"Open Sans", Sans-serif', }}>
      ...
      label: 'Product Engineering', content:
        <div style={{ justifyContent: 'center', alignContent: 'center' }}>
          <ScrollArea h={700}>
            ...
            <Text fz={17.5} style={{ fontFamily: '"Open Sans", Sans-serif', animation: "slideInBottomToTop 1.5s ease-out" }}>Aaradhya Techno Solutions excels in a wide range of engineering domains, including PCB design, FPGA development, embedded software, system software, application software, and mechanical design. We provide end-to-end solutions for embedded systems development, covering every stage of the product life cycle—from initial conceptualization and requirements gathering to verification, validation, qualification, prototyping, and long-term support.</Text>


            <Center mt='5rem'>
              <Image
                style={{ animation: isVisible ? "slideInBottomToTop 3s ease-out" : "slideInBottomToTop 3s ease-out", }}
                src='https://www.bursys.com/wp-content/uploads/2023/04/six-stages-of-product-development.png' width='80vh'> </Image>
            </Center>
            <div style={{ marginTop: '2rem' }}>
              <Text fz={20} fw='bold' style={{ fontFamily: '"Marcellus", Sans-serif', animation: isVisible ? "slideInBottomToTop 3s ease-out" : "slideInBottomToTop 3s ease-out", }} >Comprehensive Product Engineering Support </Text>
              <Text fz={17.5} style={{ fontFamily: '"Open Sans", Sans-serif', }}>
              ...
              <Text mt='lg' fz={20} style={{ fontFamily: '"Marcellus", Sans-serif', animation: isVisible ? "slideInBottomToTop 3s ease-out" : "slideInBottomToTop 3s ease-out", }}>

                <b>Key Products and Solutions</b>
                <ol type='1' style={{ fontFamily: '"Open Sans", Sans-serif', fontSize: '17.5px' }}>
                  <li>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: '2.5rem', animation: isVisible ? "slideInBottomToTop 3.5s ease-out" : "slideInBottomToTop 3.5s ease-out", }}>
                    ...
                    <div style={{ flex: 0.7, marginLeft: '2.5rem' }}>
                      <li><b style={{ fontFamily: '"Marcellus", Sans-serif', }}>High-Power BLDC Motor Controllers :</b> Aaradhya Techno Solutions offers versatile and optimized solutions for motion control, supporting a wide range of voltage and current ratings.
                        <ul type='disc'>
      ...
      label: 'RF and Microwave Design', content:
        <div style={{ justifyContent: 'center', alignContent: 'center' }}>
          <ScrollArea h={700}>
            ...
            <Text fz={20} fw='bold' style={{ fontFamily: '"Marcellus", Sans-serif', animation: isVisible ? "slideInBottomToTop 3s ease-out" : "slideInBottomToTop 3s ease-out" }}>Expertise in RF Modules and Microwave Assemblies</Text>
            <Text fz={17.5} style={{ fontFamily: '"Open Sans", Sans-serif', animation: isVisible ? "slideInBottomToTop 3s ease-out" : "slideInBottomToTop 3s ease-out" }} >Aaradhya Techno Solutions specializes in delivering custom RF modules and integrated microwave assemblies, leveraging extensive expertise in RF and microwave design, assembly, and testing. Our proven capabilities span from initial concept development to environmental testing and qualification, ensuring reliable and high-performing solutions tailored to meet your specific needs.</Text>
            ...
            <div style={{ marginTop: '2rem', animation: isVisible ? "slideInBottomToTop 3s ease-out" : "slideInBottomToTop 3s ease-out", }}>
              <Text fz={20} fw='bold' style={{ fontFamily: '"Marcellus", Sans-serif', }}>Comprehensive RF and Microwave Services </Text>
              <Text fz={17.5} style={{ fontFamily: '"Open Sans", Sans-serif', animation: isVisible ? "slideInBottomToTop 3s ease-out" : "slideInBottomToTop 3s ease-out", }}>
                ...
                <Text mt='lg' fs={20} style={{ fontFamily: '"Marcellus", Sans-serif', fontWeight: 'bolder' }}>
                ...
                <br />
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: '2rem', animation: isVisible ? "slideInBottomToTop 3s ease-out" : "slideInBottomToTop 3s ease-out", }}>
                  ...
                  <div style={{ flex: 0.35, animation: isVisible ? "slideInBottomToTop 3s ease-out" : "slideInBottomToTop 3s ease-out", }}><Image src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQgfK9REOGYxSIOQa_4x6mnen9q6vHQe-xnQg&s'></Image></div>
                </div>

                <br />
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: '2.5rem' }}>
                  <div style={{ flex: 0.4, marginRight: '2rem', }} ><Image style={{ animation: isVisible ? "slideInBottomToTop 3s ease-out" : "slideInBottomToTop 3s ease-out", }} src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQCOKuB0tTKM3pyqJdZZm-YjZ3lJlqc45aSlQ&s'></Image></div>
      ...
      label: 'PCB Design and Analysis', content:
        <div style={{ justifyContent: 'center', alignContent: 'center' }}>
          <ScrollArea h={700}>
            ...
            <Text fz={20} fw='bold' style={{ fontFamily: '"Marcellus", Sans-serif', animation: isVisible ? "slideInBottomToTop 3s ease-out" : "slideInBottomToTop 3s ease-out" }}>Comprehensive PCB Layout and Analysis Services</Text>
            <Text fz={17.5} style={{ fontFamily: '"Open Sans", Sans-serif', animation: isVisible ? "slideInBottomToTop 3s ease-out" : "slideInBottomToTop 3s ease-out" }} >At Aaradhya Techno Solutions, we provide advanced PCB layout services to meet the diverse needs of modern electronics, from simple prototype boards to complex, high-performance multi-layer designs. Our expertise spans a range of applications, including multi-gigabit systems and high-volume consumer electronics, with a strong emphasis on signal integrity, manufacturability, and reliability.</Text>
  ...
  const links = navLinks.map((item) => (
    ...
    >
      <Link
        to={`/service/${item.label.replace(/\s+/g, '-')}`}
        className={`nav-link ${item.label.replace(/\s+/g, '-') === active ? 'active' : ''}`}
        onClick={() => setActive(item.label.replace(/\s+/g, '-'))}
      >
        {item.label}
      </Link>
  ...
  const activeContent = navLinks.find((item) => item.label.replace(/\s+/g, '-') === active)?.content;
