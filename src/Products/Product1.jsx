...
import { Navbar, ScrollArea, Text, Image, Center, Transition, Affix, rem, Button, AppShell } from '@mantine/core';
...
const Product1 = () => {
      ...
      label: 'Systems', content:
        <div
          ...
          <ScrollArea h={600}>
            ...
            <Center>
              <Image src={Image1} width='70vh' style={{ animation: isVisible ? "slideInBottomToTop 3s ease-out" : "slideInBottomToTop 3s ease-out" }}> </Image>
        ...
        <div style={{ justifyContent: 'center', alignContent: 'center', }}>
          <ScrollArea h={600}>
            ...
            <div style={{ marginTop: '2rem', }}>
              <Text style={{ fontFamily: '"Marcellus", Sans-serif', animation: isVisible ? "slideInBottomToTop 3s ease-out" : "slideInBottomToTop 3s ease-out", }} fw={700} fz={17.5}>Wide Range of PC Add-On Cards by Aaradhya Techno Solutions</Text>
              <Text fz={17.5} style={{ fontFamily: '"Open Sans", Sans-serif', animation: isVisible ? "slideInBottomToTop 3s ease-out" : "slideInBottomToTop 3s ease-out" }}>Aaradhya Techno Solutions offers an extensive selection of PC add-on cards designed to meet diverse application requirements. Our portfolio includes advanced solutions for communication, data acquisition, and signal processing, tailored for high performance and reliability. </Text>
              <Text fz={17.5} style={{ fontFamily: '"Marcellus", Sans-serif', alignContent: 'center', animation: isVisible ? "slideInBottomToTop 3s ease-out" : "slideInBottomToTop 3s ease-out", }}>
                <ol type='1' style={{ fontFamily: '"Open Sans", Sans-serif', }}>
                  <li>
      ...
      label: 'Bus Couplers and Accessories', content:
        <div style={{ justifyContent: 'center', alignContent: 'center' }}>
          <ScrollArea h={600}>
            ...
            <div style={{ marginTop: '2rem', }}>
              <Text fw={700} fz={20} style={{ fontFamily: '"Marcellus", Sans-serif', animation: isVisible ? "slideInBottomToTop 3s ease-out" : "slideInBottomToTop 3s ease-out", }}>Wide Range of Bus Couplers and Accessories from Aaradhya Techno Solutions</Text>
              <Text fz={17.5} style={{ fontFamily: '"Open Sans", Sans-serif', animation: isVisible ? "slideInBottomToTop 3s ease-out" : "slideInBottomToTop 3s ease-out", }} >Aaradhya Techno Solutions offers a diverse selection of bus couplers and related components, designed to meet industry standards and ensure optimal performance. Our range includes :</Text>
      ...
      label: 'Electronics and Electromechanical', content:
        <div style={{ justifyContent: 'center', alignContent: 'center' }}>
          <ScrollArea h={600}>
            ...
            <div style={{ marginTop: '2rem' }}>
              <Text fw={700} fz={20} style={{ fontFamily: '"Marcellus", Sans-serif', animation: isVisible ? "slideInBottomToTop 3s ease-out" : "slideInBottomToTop 3s ease-out", }}>Diverse Range of Electronic Components from Aaradhya Techno Solutions</Text>
              <Text fz={17.5} style={{ fontFamily: '"Open Sans", Sans-serif', animation: isVisible ? "slideInBottomToTop 3s ease-out" : "slideInBottomToTop 3s ease-out", }} >Aaradhya Techno Solutions provides an extensive selection of high-quality electronic components, catering to commercial, industrial, and military applications. Our offerings include :</Text>
              <Text fz={17.5} style={{ fontFamily: '"Open Sans", Sans-serif', animation: isVisible ? "slideInBottomToTop 2.5s ease-out" : "slideInBottomToTop 2.5s ease-out", }}>
                <ol type='1'>
                  <li>
      ...
      label: 'Software', content:
        <div style={{ justifyContent: 'center', alignContent: 'center' }}>
          <ScrollArea h={600}>
            ...
            <div style={{ marginTop: '2rem' }}>
              <Text fw={700} fz={20} style={{ fontFamily: '"Marcellus", Sans-serif', animation: isVisible ? "slideInBottomToTop 3s ease-out" : "slideInBottomToTop 3s ease-out", }}>Software Solutions Offered by Aaradhya Techno Solutions</Text>
              <Text fz={17.5} style={{ fontFamily: '"Open Sans", Sans-serif', animation: isVisible ? "slideInBottomToTop 3s ease-out" : "slideInBottomToTop 3s ease-out", }}>Aaradhya Techno Solutions delivers cutting-edge software solutions designed to enhance efficiency and productivity in various domains. Our offerings include :</Text>
              <Text fz={17.5} style={{ fontFamily: '"Open Sans", Sans-serif', animation: isVisible ? "slideInBottomToTop 2.5s ease-out" : "slideInBottomToTop 2.5s ease-out", }}>
                <ol type='1'>
                  <li>
      ...
      label: 'Test and Measurements', content:
        ...
        <div style={{ justifyContent: 'center', alignContent: 'center' }}>
          <ScrollArea h={600}>
            ...
            <div style={{ marginTop: '2rem', animation: isVisible ? "slideInBottomToTop 3s ease-out" : "slideInBottomToTop 3s ease-out", }}>
              <Text fw={700} fz={20} style={{ fontFamily: '"Marcellus", Sans-serif', }}>Measurement Devices Offered by Aaradhya Techno Solutions</Text>
              <Text fz={17.5} style={{ fontFamily: '"Marcellus", Sans-serif', }}>Aaradhya Techno Solutions provides a diverse array of measurement devices tailored to meet the needs of various industries. Our selection includes :</Text>
              <Text fz={17.5} style={{ fontFamily: '"Open Sans", Sans-serif', animation: isVisible ? "slideInBottomToTop 2.5s ease-out" : "slideInBottomToTop 2.5s ease-out", }}>
                <ol type='1'>
                  <li>
        ...
        <div style={{ justifyContent: 'center', alignContent: 'center' }}>
          <ScrollArea h={600}>
            ...
            <div style={{ marginTop: '2rem', animation: isVisible ? "slideInBottomToTop 1.5s ease-out" : "slideInBottomToTop 1.5s ease-out", }}>
              <Text fw={700} fz={20} style={{ fontFamily: '"Marcellus", Sans-serif', }}>Raw Material Solutions from Aaradhya Techno Solutions</Text>
              <Text fz={17.5} style={{ fontFamily: '"Open Sans", Sans-serif', }}>Aaradhya Techno Solutions supplies a diverse range of premium raw materials to cater to various industrial applications. Our offerings include :</Text>
              <Text fz={17.5} style={{ fontFamily: '"Open Sans", Sans-serif', animation: isVisible ? "slideInBottomToTop 1.5s ease-out" : "slideInBottomToTop 1.5s ease-out", }}>
                <ol type='1'>
                  <li>
  ...
  const links = navLinks.map((item) => (
    ...
    >
      <Link
        to={`/product/${item.label.replace(/\s+/g, '-')}`}
    ...
    >
      <>
        ...
        >
          ...
          >
            <Text color='white'>{activeContent}</Text>
          </div>
        </div>
